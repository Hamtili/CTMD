package itec.fh.cmm.jpeg.enc;

import itec.fh.cmm.jpeg.impl.BlockGenerator;
import itec.fh.cmm.jpeg.impl.ImageScalator;
import itec.fh.cmm.jpeg.spec.BlockGeneratorI;
...
import itec.fh.cmm.jpeg.spec.EntropyCoderI;
import itec.fh.cmm.jpeg.spec.ImageScalatorI;
import itec.fh.cmm.jpeg.spec.MinimumCodedUnitI;
import itec.fh.cmm.jpeg.spec.QuantizationI;
import itec.fh.cmm.jpeg.spec.RegionI;
import itec.fh.cmm.jpeg.spec.RunLevelI;
import itec.fh.cmm.jpeg.spec.SubSamplerI;
import itec.fh.cmm.jpeg.spec.YUVImageI;
import itec.fh.cmm.jpeg.stud.ColorSpaceConverter;
import itec.fh.cmm.jpeg.stud.HuffmanCoder;
import itec.fh.cmm.jpeg.stud.Quantizer;
import itec.fh.cmm.jpeg.stud.StandardDCT;
import itec.fh.cmm.jpeg.stud.SubSampler;
...
public class JPEGTest {
    ...
    public static void main(String[] args) {
        try {
            if (args.length == 1 || args.length == 3 ||  args.length == 5) {
                ...
                System.out.print("\nUsage: java itec.fh.cmm.jpeg.test.JPEGTest [-s <samplingRatio>] [-q <qualityFactor>] <imgFile>");
        }
        catch (Exception e) {
    ...
    protected static void showImageInfo(YUVImageI yuvImg, String samplingString) {
        ...
        System.out.print("\nY: " + yuvImg.getComponent(YUVImageI.Y).getSize());
        System.out.print("\nCb: " + yuvImg.getComponent(YUVImageI.Cb).getSize());
        System.out.print("\nCr: " + yuvImg.getComponent(YUVImageI.Cr).getSize());
        System.out.print("\n-------------------------------");
    }
